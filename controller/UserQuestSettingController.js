...
<html>
  ...
  <body class="flex min-h-screen items-center w-full justify-center">
    <div
    ...
    >
      ...
      <div class="pb-6">
        ...
        <div class="flex"></div>
        <div
          class="flex w-full justify-between gap-[0.75rem] pl-[3.44rem] pr-[3.44rem]"
        >
          <div class="flex w-full justify-between">
            <div></div>
            <button
              class="flex cursor-pointer select-none items-center justify-center [outline:none] disabled:cursor-not-allowed rounded-[0.9375rem] rounded addoption-boxShadow bg-gradient-to-tr from-[#6BA5CF] to-[#389CE3] font-semibold text-white h-[3.125rem] min-w-[10.8125rem] text-[1.25rem] px-[17px]"
              id="submit-66323b91a1afbaec5c54de33"
            >
              Submit<span
                class="font-semibold leading-[1px] pl-[10px] text-[13px]"
                >(+0.96 FDX)</span
              >
            </button>
          </div>
