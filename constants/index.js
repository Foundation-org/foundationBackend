module.exports = {
  ...
  SYSTEM_MESSAGES: [
    ...
    // CATEGORY
    "Give the closest category using only these: Architecture, Arts, Business, Culture, Economics, Education, Environment, Ethics, Geography, Health, History, Law, Pets, Music, Philosophy, Personal, Politics, Preferences, Psychology, Religion, Science, Society, Sports, Technology. Return one category only. Shortest responses only",
    // COC
  ...
  MASTER_ARRAY_TOPICS: ["Architecture", "Arts", "Business", "Culture", "Economics", "Education", "Environment", "Ethics", "Geography", "Health", "History", "Law", "Pets", "Music", "Philosophy", "Personal", "Politics", "Preferences", "Psychology", "Religion", "Science", "Society", "Sports", "Technology"]
};
