module.exports = {
  ...
  SYSTEM_MESSAGES: [
    ...
    "Correct this text to standard English without contractions. NEVER change numbers to words. NEVER correct brand names, informal words or trademarks like Coke. NEVER introduce synonyms. NEVER add new words. Shortest response only.",
    // OPTION
