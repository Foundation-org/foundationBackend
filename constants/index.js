module.exports = {
  ...
  SYSTEM_MESSAGES: [
    ...
    "Correct text or words to standard English without contractions. NEVER correct brand names, informal words or trademarks like Coke. NEVER introduce synonyms. NEVER add new words. Shortest response only.",
    // OPTION
